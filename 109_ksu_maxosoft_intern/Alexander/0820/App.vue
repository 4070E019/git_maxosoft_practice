<template>
 ...
 <select v-model="selected" style="margin-left:10px">
...
<div class="bar">
<input type="text" v-model="searchTerm" style="width:1500px; height:30px"  placeholder="Select" />
</div>
<br>    
